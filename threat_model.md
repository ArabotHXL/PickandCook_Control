...
- High-risk API modules: `routes/ops/auth.ts`, `routes/ops/totp.ts`, `routes/ops/users.ts`, `routes/ops/recipeDetail.ts`, `routes/ops/recipesStaging.ts`, `routes/ops/system.ts`, `routes/ops/flags.ts`, `routes/ops/csv.ts`, `lib/objectStorage.ts`, `lib/alerts.ts`, and `jobs/scheduler.ts`.
